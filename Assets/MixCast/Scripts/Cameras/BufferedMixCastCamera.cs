...
namespace BlueprintReality.MixCast
{
    ...
    public class BufferedMixCastCamera : MixCastCamera
    {
        ...
        void RenderBackground(GameFrame targetFrame)
        {
            ...
            cleanProxyCamera.nearClipPlane = Mathf.Clamp(targetFrame.playerDepth - 0.5f * layerOverlap, 0.001f, cleanProxyCamera.farClipPlane - 0.001f);
            ...
            if( forceToBackground > 0 )
            {
                ...
                cleanProxyCamera.farClipPlane = targetFrame.playerDepth + 0.5f * layerOverlap;
        ...
        void RenderForeground(GameFrame targetFrame)
        {
            ...
            cleanProxyCamera.farClipPlane = Mathf.Max(cleanProxyCamera.nearClipPlane + 0.001f, targetFrame.playerDepth + 0.5f * layerOverlap);
        ...
        float CalculatePlayerDistance()
        {
            ...
            return Vector3.Dot(cleanProxyCamera.transform.forward, playerPosition - cleanProxyCamera.transform.position);
        }
    }
}